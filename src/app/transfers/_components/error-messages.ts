...
const messages: Readonly<Record<string, string>> = {
  ...
  "transfers.dispatch_forbidden":
    "Vous n’avez pas l’autorisation d’expédier depuis cette boutique.",
  "transfers.insufficient_stock":
    "Le stock disponible ne permet pas cette expédition.",
  "transfers.invalid_state":
    "Ce transfert a changé d’état. Actualisez la liste.",
  ...
  "transfers.reception_forbidden":
    "Vous n’avez pas l’autorisation de réceptionner dans cette boutique.",
