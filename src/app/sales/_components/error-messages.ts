const messages: Readonly<Record<string, string>> = {
  ...
  "inventory.insufficient_stock":
    "Le stock disponible est insuffisant pour finaliser cette vente.",
  "sales.cart_not_found":
    "Ce panier n’est plus disponible. Commencez une nouvelle vente.",
  ...
  "sales.product_not_found":
    "Ce produit n’est pas actif ou ne possède pas de prix courant.",
  "sales.shop_not_found":
    "La boutique de travail n’est pas active ou n’appartient pas à cette organisation.",
  "sales.under_cost_reason_required":
    "Une justification est obligatoire pour une vente sous coût.",
