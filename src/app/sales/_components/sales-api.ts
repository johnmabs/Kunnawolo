...
export function createCart(
  ...
  return apiRequest("/api/sales/carts", access, {
    method: "POST",
    body: JSON.stringify({ organizationId: access.organizationId, shopId }),
  });
}
...
export function addLine(
  ...
  return apiRequest(`/api/sales/carts/${cartId}/lines`, access, {
    method: "POST",
    body: JSON.stringify({
      organizationId: access.organizationId,
      productId,
...
export function removeLine(
  ...
  return apiRequest(`/api/sales/carts/${cartId}/lines`, access, {
    method: "DELETE",
    body: JSON.stringify({ organizationId: access.organizationId, lineId }),
  });
}
...
export async function finalizeCart(
  ...
  await apiRequest(`/api/sales/carts/${cartId}/finalization`, access, {
    method: "POST",
    body: JSON.stringify({
      organizationId: access.organizationId,
...
export function paySale(
  ...
  return apiRequest(`/api/sales/carts/${cart.id}/payment`, access, {
    method: "POST",
    body: JSON.stringify({
      organizationId: access.organizationId,
