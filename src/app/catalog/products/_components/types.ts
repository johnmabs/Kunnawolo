...
export type ProductInput = Readonly<{ name: string; code: string; barcode: string; packaging: string; form: string; trackInventory: boolean }>;

export class CatalogApiError extends Error {
  public constructor(public readonly code: string) { super(code); this.name = "CatalogApiError"; }
}
