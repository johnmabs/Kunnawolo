    ...
    return (
      <PageContainer>
        <EmptyState
          ...
          description="Sélectionnez ou créez une boutique de travail pour gérer son stock."
