...
export function SignupForm() {
  const [state, action, pending] = useActionState(signupAction, { error: null } satisfies SignupState);
  return (
    <form action={action} className="grid gap-5">
      ...
      <Button className="w-full" isLoading={pending} size="lg" type="submit">Créer mon compte</Button>
