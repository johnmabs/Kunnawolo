  ...
  return (
    <main className="grid min-h-dvh bg-background lg:grid-cols-[minmax(20rem,0.85fr)_minmax(32rem,1.15fr)]">
      <section className="relative hidden overflow-hidden bg-sidebar p-12 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <Link className="relative text-xl font-bold tracking-tight" href="/">
          astu-sales
        </Link>
        <div className="relative max-w-md">
          ...
          <p className="mt-4 text-4xl font-semibold leading-tight">
            Ventes, stocks et dépenses dans un seul espace de travail.
          </p>
          <p className="mt-5 text-base leading-7 text-slate-300">
            Une interface claire pour rester concentré sur les opérations
            quotidiennes.
          </p>
        </div>
        <p className="relative text-sm text-slate-400">
          Astu Sales · Gestion commerciale
        </p>
      </section>
      <section className="flex items-center justify-center px-4 py-10 sm:px-8 lg:px-12">
        <div className="w-full max-w-md">
          <Link
            className="mb-10 inline-block text-xl font-bold tracking-tight text-sidebar lg:hidden"
            href="/"
          >
            astu-sales
          </Link>
