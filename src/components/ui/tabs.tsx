...
>(function TabsList({ className, ...props }, ref) {
  return (
    <TabsPrimitive.List
      className={cn(
        "inline-flex min-h-11 max-w-full items-center gap-1 overflow-x-auto rounded-md bg-surface-subtle p-1",
        className,
      )}
      ref={ref}
      {...props}
...
>(function TabsContent({ className, ...props }, ref) {
  return (
    <TabsPrimitive.Content
      className={cn(
        "mt-4 outline-none focus-visible:ring-3 focus-visible:ring-primary/20",
        className,
      )}
      ref={ref}
      {...props}
