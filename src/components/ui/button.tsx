...
const variants: Record<ButtonVariant, string> = {
  ...
  secondary:
    "border-border bg-surface text-text-primary hover:bg-surface-subtle",
  ghost:
    "border-transparent bg-transparent text-text-primary hover:bg-surface-subtle",
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  function Button(
    ...
    if (asChild) {
      return (
        <Slot.Root className={styles} ref={ref} {...props}>
          {children}
        </Slot.Root>
      );
    }
