...
export class UpdateProduct {
  ...
  public async execute(input: ProductDetails & Readonly<{ organizationId: string; productId: string; actorId: string | null; isActive: boolean }>) {
    ...
    await this.products.save(updated, { organizationId: input.organizationId, actorId: input.actorId, action: "product.updated" });
    return updated;
  }
}
