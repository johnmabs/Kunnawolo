...
describe("inventory list projections", () => {
  it("computes low stock, inventory progress and loss value", () => {
    const stock = StockListProjection.create({
      organizationId: "org",
      shopId: "shop",
      shopName: " Boutique Ɛ ",
      items: [
    ...
    expect(stock).toMatchObject({
      shopName: "Boutique Ɛ",
      items: [{ isLowStock: true }],
    });

    const sessions = InventorySessionListProjection.create({
      organizationId: "org",
      shopId: "shop",
      shopName: "Boutique",
      items: [
    ...
    const losses = StockLossHistoryProjection.create({
      organizationId: "org",
      shopId: "shop",
      productId: "product",
      items: [
