...
class Levels implements StockLevelRepository { public saved: StockLevel | null = null; public async ensure(level: StockLevel): Promise<StockLevel> { this.saved ??= level; return this.saved; } public async find(): Promise<StockLevel | null> { return this.saved; } }
