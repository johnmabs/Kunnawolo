...
export class CancelExpense {
  public constructor(
    private readonly cancellations: ExpenseCancellationRepository,
  ...
  public async execute(
    ...
    if (existing !== null) {
      if (existing.expenseId.value !== input.expenseId)
    ...
    const cancellation = ExpenseCancellation.create({
      ...
      expenseId: Identifier.fromString(input.expenseId),
      reference,
      reason: input.reason,
