...
import type {
  ...
  ExpenseListItem,
} from "./ports/expense-consultation-repository";
import type { ExpenseReadAuthorization } from "./ports/expense-read-authorization";

export class ListExpenses {
  public constructor(
    private readonly expenses: ExpenseConsultationRepository,
    private readonly authorization: ExpenseReadAuthorization,
  ) {}
