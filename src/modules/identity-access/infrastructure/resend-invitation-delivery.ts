  ...
  public constructor(
    ...
    if (!apiKey.trim() || !from.trim())
      throw new DomainError(
        "iam.invitation_delivery_unavailable",
        "Resend API key and sender are required.",
      );
  ...
  public async send(
    ...
    if (response.error !== null)
      throw new DomainError(
        ...
        "Resend could not deliver the membership invitation.",
