...
| 9 | IN_PROGRESS | 9.4 — Performance et résilience (DONE — 2026-09-02 : `pnpm lint`, `pnpm typecheck`, `pnpm test -- --maxWorkers=1`, `pnpm build` et `pnpm db:migrate:status` réussis.) |
